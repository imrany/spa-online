...
const Products=()=>{
    return(
        <div className="flex py-20 flex-col items-center bg-transparent" id="about">
            ...
            <p className="text-4xl text-center mt-6 w-[50vw] font-semibold text-[#333333]">
            ...
            <div className="mt-10 justify-center items-center flex max-md:flex-col gap-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-x-5">
                <div className="flex flex-col w-[30vw] max-md:w-[50vw]">
                    <img src={image1} alt="product images" className="max-md:h-[20vh]"/>
                ...
                <div className="flex flex-col w-[30vw] max-md:w-[50vw]">
                    <img src={image2} alt="product images" className="max-md:h-[20vh]"/>
                    <p className="mt-10 text-[#333333]">
                        Natural Oil
                    </p>
                    <p className="mt-2 text-[#808080]">
