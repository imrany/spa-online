    ...
    return (
        <dialog id="user-dialog" className="shadow-lg rounded-md flex flex-col lg:w-[35vw] max-md:w-[80vw] max-sm:w-[75vw] h-fit text-[#808080] max-sm:scale-[0.5]">
            ...
            <div className="flex flex-col w-full text-center">
                <Link onClick={dialog_close} to="/auth/register" className="hover:text-[#F45858] py-2  text-xl  max-sm:text-base">
                    <i className="ri-add-circle-fill mr-2"></i>
                    Create account
                </Link>
                <Link onClick={dialog_close} to="/auth" className="text-xl hover:text-[#F45858] py-2 max-sm:text-base ">
